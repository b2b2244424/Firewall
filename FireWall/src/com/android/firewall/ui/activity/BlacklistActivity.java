...
public class BlacklistActivity extends Activity implements OKListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.delete_all_item:
			DatabaseManager.getInstance(getApplicationContext()).clearAllBlacklist();
			dataChanged();
			break;
		case R.id.test_item:
	...
	private Cursor getBlackListCursor(){
		return getContentResolver().query(URIConstants.URI_BLACKLIST, null, null, null, null);
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		BlacklistViewHolder holder=(BlacklistViewHolder)info.targetView.getTag();
		switch (item.getItemId()) {
		case R.id.edit_menu:
			Bundle args=new Bundle();
			args.putString(FirewallConstants.KEY_ID, holder.tv_id.getText().toString());
			args.putString(FirewallConstants.KEY_PHONE, holder.tv_phone.getText().toString());
			args.putString(FirewallConstants.KEY_NAME, holder.tv_name.getText().toString());
			args.putBoolean(FirewallConstants.KEY_PHONE_BLOCK, holder.cb_phone_block.isChecked());
			args.putBoolean(FirewallConstants.KEY_MSG_BLOCK, holder.cb_msg_block.isChecked());
			EntryEditDialog dialog=new EntryEditDialog();
		...
		case R.id.delete_menu:
			...
			DatabaseManager.getInstance(getApplicationContext()).deleteBlacklistEntry(id);
			dataChanged();
			break;
		default:
			break;
