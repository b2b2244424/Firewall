...
public class DatabaseManager {
	...
	public Cursor queryBlacklistEntry(String num) {
		return mContext.getContentResolver().query(URIConstants.URI_BLACKLIST,
				new String[] { BlacklistConlums._ID, BlacklistConlums.NUMBER },
				BlacklistConlums.NUMBER + "=?", new String[] { num }, null);
	}

	public void deleteBlacklistEntry(int id) {
		mContext.getContentResolver().delete(URIConstants.URI_BLACKLIST,
				BlacklistConlums._ID + "=" + id, null);
	}

	public void clearAllBlacklist() {
		mContext.getContentResolver().delete(URIConstants.URI_BLACKLIST, null,
				null);
	}
	...
	public void insertOrUpdatePBR(PBRInfo info) {
		...
		mContext.getContentResolver().insert(URIConstants.URI_PBR, localValues);
	}

	public void deletePBREntry(int id) {
		mContext.getContentResolver().delete(URIConstants.URI_PBR,
				PBRConlums._ID + "=" + id, null);
	}
